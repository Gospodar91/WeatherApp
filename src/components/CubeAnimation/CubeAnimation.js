...
function qubeAnimation() {
    ...
    gsap.to('.gw-part', {duration:30, x:-500, y:-420, borderRadius:'15px', rotate:500, backgroundColor:'transparent', border: "5px solid white",scale:1.2});
    gsap.to('.gw-part__item', {duration:30, borderRadius:'15px', x:500, y:-400, rotate:340, backgroundColor:'transparent', border: "5px solid white", scale:1.2});
};